...
//        MultipartFile arquivo = fotoProdutoInput.getArquivo();
    ...
    public ResponseEntity<?> servir(@PathVariable Long restauranteId,
        ...
        try {
            ...
            verificarCompatabilidadeMediaType(mediaTypeFoto, mediaTypesAceitas );
    ...
    private void verificarCompatabilidadeMediaType(
            MediaType mediaTypeFoto, List<MediaType> mediaTypesAceitas)
            throws HttpMediaTypeNotAcceptableException {

        boolean compativel =  mediaTypesAceitas.stream()
                .anyMatch(mediaTypeAceita -> mediaTypeAceita.isCompatibleWith(
                        mediaTypeFoto));
