...
//    @Multiplo(numero = 5)
    ...
    //Alterado de List para Set para evitar erro de constraint de forma de pagamento quando tentar inserir
    //duas vezes a mesma forma de pagamento para o mesmo restaurante
